...
static void prv_create_canvas() {
  ...
  s_place_layer = text_layer_create(GRect(0, 113, 144, 30));
  ...
  s_duration_layer = text_layer_create(GRect(0, 95, 144, 30));
